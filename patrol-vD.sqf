///////Simple Patrol script vD 1.82 - SPUn / LostVar
//
...
//     or: nul = [this,center position,radius,handle doors] execVM "patrol-vD.sqf";
...
if(isNil("LV_CloseDoors"))then{LV_CloseDoors = compile preprocessFile "LV_functions\LV_fnc_closeDoors.sqf";};
if(isNil("LV_nearestBuilding"))then{LV_nearestBuilding = compile preprocessFile "LV_functions\LV_fnc_nearestBuilding.sqf";};
_unit = _this select 0;
_cPos = _this select 1;
_radius = _this select 2;
_handleDoors = _this select 3;
