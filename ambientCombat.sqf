/*
				***		ARMA3Alpha AMBIENT COMBAT SCRIPT v1.99 - by SPUn / lostvar	***
			...
			while{!_spotValid}do{
				...
				if(surfaceIsWater _spawnPos)then{
					...
					while{count _isFlat == 0}do{ //check if there's land at _maxRange
						...
						_isFlat = _tempPos isflatempty [2,0,1,2,0,true];
						_d1 = _d1 + 45;
